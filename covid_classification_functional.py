...
"""
from src.models.classificacao.funcional_model import classification_model, fit
...
for net, net_path in zip(NETS[1:], nets_path[1:]):
    ...
    covid = classification_model(dim=224)
    
    fit(covid, train_generator, val_generator,1,1)
