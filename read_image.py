...
def read_random_image(paths: list, id_start: list) -> list:
...
def read_images(images_paths, id_start=0, id_end=-1):
    """ Lê as imagens do listas de caminhos da imagem de start até end -1

    Args:
        images_paths (str or list): Arrays contndo os caminhos das imagens.
        id_start (int or list,optional): ID do inicio das imagens. Defaults to 0.
        id_end (int, optional): ID do fim das imagens. Defaults to -1.
